...
#include <cstdint>
#include "gpu_warp.cuh"          // WARP_SIZE, LANE_MASK, U32_BITS, U64_BITS, BITS_PER_BYTE
#include "gpu_byteio.cuh"        // read8safe, readU32LE, readU64LE, readBE24, writeBE24, writeLE24
#include "gpu_wire_format.cuh"   // LZ_BLOCK_SIZE, INITIAL_LITERAL_COPY_BYTES, OFF32_LONG_ENTRY_TAG, ...
