...
// Gate-2 resurrection stub: the three constants bit_reader's
// distance helpers need, inlined from the retired
// src/format/streamlz_constants.zig (the tANS encode path never
// calls those helpers, but the file must compile).
