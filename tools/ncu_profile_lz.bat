...
"C:\Program Files\NVIDIA Corporation\Nsight Compute 2025.4.0\ncu.bat" ^
  --set full ^
  --kernel-name slzLzDecodeRawKernel ^
  --launch-count 1 ^
  -o c:\tmp\slz_lz_raw_post12 ^
  %~dp0..\zig-out\bin\streamlz.exe -d c:\tmp\bench_e_L1.slz -o c:\tmp\ncu_out.bin
echo.
echo ================================================================
echo Profile saved to c:\tmp\slz_lz_raw_post12.ncu-rep
echo.
...
"C:\Program Files\NVIDIA Corporation\Nsight Compute 2025.4.0\ncu.bat" ^
  ...
  --launch-count 1 ^
  -o c:\tmp\slz_lz_general_post12 ^
  %~dp0..\zig-out\bin\streamlz.exe -d c:\tmp\bench_e_L5.slz -o c:\tmp\ncu_out.bin
echo.
echo ================================================================
echo Profile saved to c:\tmp\slz_lz_general_post12.ncu-rep
echo.
