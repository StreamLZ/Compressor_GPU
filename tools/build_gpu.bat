...
set SRC=%~dp0..\src\gpu\gpu_decode_kernel.cu
set OUT=%~dp0..\src\gpu\gpu_decode_kernel
...
set HUFF_SRC=%~dp0..\src\gpu\gpu_huff_decode_kernel.cu
set HUFF_OUT=%~dp0..\src\gpu\gpu_huff_decode_kernel
...
set HENC_SRC=%~dp0..\src\gpu\gpu_huff_kernel.cu
set HENC_OUT=%~dp0..\src\gpu\gpu_huff_kernel
...
set COMP=%~dp0..\src\gpu\gpu_decode_kernel.comp
set SPV=%~dp0..\src\gpu\gpu_decode_kernel.spv
